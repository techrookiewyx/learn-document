...
改变元素的位置和形状，一个元素只能一个transform，不会影响页面布局，其函数如下
...
z轴一般就是人眼和元素之间的距离，距离越大，元素离人越近，z轴平移属于立体效果（近大远小），默认情况下网页不支持透视，如果想要看到z轴平移的效果，需要给设置网页的视距
...
- 使用绝对定位配合变形，transform：translate（-50%，-50%），left和top设置为50%，这种方式既不用设置元素宽高，又不用在意内容多少，都可让元素居中
